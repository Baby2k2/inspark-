  ...
  return (
    <View style={styles.services3}>
      ...
      <View style={[styles.services, styles.servicesPosition]}>
        <Image
          style={[styles.image1563Icon, styles.iconLayout5]}
          contentFit="cover"
          source={require("../assets/image-1563.png")}
        />
        <Image
        ...
        <View style={[styles.groupParent, styles.servicesPosition]}>
          ...
          <Text style={[styles.loremIpsumDolor, styles.image1568IconLayout]}>
...
tristique leo.`}</Text>
                ...
                <View style={styles.groupParent2}>
                  <View style={[styles.ellipseGroup, styles.ellipseLayout]}>
                    ...
                    />
                    <Text style={[styles.text3, styles.textLayout]}>21</Text>
                  </View>
...
employees`}</Text>
        ...
        <View style={styles.uiDesignParent}>
          ...
          <View style={[styles.mockups1, styles.designLayout]}>
            <View style={[styles.rectangleContainer, styles.designLayout]}>
              <View style={[styles.frameInner, styles.designLayout]} />
              <Image
...
Transferring Solutions Next Moment`}</Text>
      ...
      <View style={styles.youAreInGoodHandsParent}>
        <Text style={[styles.youAreInContainer, styles.textTypo]}>
      ...
      />
      <View style={[styles.services3Inner, styles.parentLayout]}>
        <View style={[styles.groupParent3, styles.parentLayout]}>
          <View style={[styles.rectangleParent4, styles.parentLayout]}>
            <View style={styles.groupChild16} />
            <Image
              style={[styles.image1567Icon, styles.iconLayout5]}
              contentFit="cover"
              source={require("../assets/image-1567.png")}
            />
            <Image
              style={[styles.image1568Icon, styles.image1568IconLayout]}
              contentFit="cover"
              source={require("../assets/image-1568.png")}
            />
            <View style={[styles.groupChild17, styles.groupChild17Position]} />
            <View style={styles.developmentParent}>
              <Text style={[styles.development, styles.orTypo]}>
                DEVELOPMENT
              </Text>
              <Image
            ...
            >{`Lorem Ipsum is simply dummy text of the printing and `}</Text>
            <Image
              style={[styles.image1578Icon, styles.textLayout]}
              contentFit="cover"
              source={require("../assets/image-1578.png")}
            />
          </View>
          <Pressable
