  ...
  return (
    <View style={styles.services6}>
      ...
      <View style={[styles.services, styles.servicesPosition]}>
        <Image
          style={[styles.image1566Icon, styles.iconLayout5]}
          contentFit="cover"
          source={require("../assets/image-1566.png")}
        />
        <Image
          style={[styles.image1556Icon, styles.iconLayout3]}
          contentFit="cover"
          source={require("../assets/image-15563.png")}
        />
        ...
        <View style={styles.faq}>
          ...
          <View style={[styles.faqInner, styles.faqInnerLayout]}>
            ...
            >
              ...
              <Image
                style={[styles.groupInner, styles.iconLayout3]}
                contentFit="cover"
...
employees`}</Text>
        ...
        <Text style={[styles.ourProcess, styles.content2Layout]}>
          OUR PROCESS
        </Text>
        <View style={styles.uiDesignParent}>
          ...
          <View style={[styles.design, styles.designLayout]}>
            <View style={[styles.rectangleContainer, styles.designLayout]}>
              ...
              <Image
                style={[styles.d2Icon, styles.iconLayout5]}
                contentFit="cover"
        ...
        <Text style={[styles.recentWorks, styles.groupLayout]}>
          Recent Works
        </Text>
        <LinearGradient
          style={styles.cover}
...
Transferring Solutions Next Moment`}</Text>
        ...
        <View style={styles.servicesInner2}>
          <View style={styles.parentLayout}>
            <View style={[styles.rectangleParent3, styles.parentLayout]}>
              <View style={[styles.groupChild13, styles.mockups1Position]} />
              <Image
                style={[styles.image1573Icon, styles.iconLayout5]}
                contentFit="cover"
                source={require("../assets/image-1573.png")}
              />
              <Image
                style={styles.image1574Icon}
                contentFit="cover"
                source={require("../assets/image-1574.png")}
              />
              <View style={styles.groupChild14} />
              <View style={styles.contentParent}>
                <Text style={[styles.content2, styles.orTypo]}>CONTENT</Text>
                <Image
              ...
              <Image
                style={[styles.image1560Icon, styles.iconLayout3]}
                contentFit="cover"
              ...
              />
              <Text style={styles.loremIpsumIs1}>
              ...
              <Image
                style={styles.image1575Icon}
                contentFit="cover"
                source={require("../assets/image-1575.png")}
              />
            </View>
            <Pressable
              ...
              onPress={() => navigation.navigate("IPhone14ProMax6")}
            >
              <View style={[styles.groupChild17, styles.groupLayout]} />
        ...
        <View style={styles.beneficiosDeLaMejaraDeProParent}>
          ...
          />
          <Text
            style={[styles.loremIpsumIs3, styles.loremLayout]}
          >{`Lorem Ipsum is simply dummy text of the printing and `}</Text>
          <Text
            style={[styles.loremIpsumIs4, styles.loremLayout]}
          >{`Lorem Ipsum is simply dummy text of the printing and `}</Text>
          <Text
            style={[styles.loremIpsumIs5, styles.loremLayout]}
          >{`Lorem Ipsum is simply dummy text of the printing and `}</Text>
          <Text
      ...
      <View style={styles.youAreInGoodHandsParent}>
        ...
        <Pressable
          style={[styles.rectangleParent4, styles.groupLayout]}
