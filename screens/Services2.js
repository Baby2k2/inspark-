  ...
  return (
    <View style={styles.services2}>
      ...
      <View style={[styles.services, styles.servicesPosition]}>
        <Image
          style={[styles.image1558Icon, styles.iconLayout5]}
          contentFit="cover"
          source={require("../assets/image-1558.png")}
        />
        <Image
          style={[styles.image1556Icon, styles.iconLayout3]}
          contentFit="cover"
          source={require("../assets/image-1556.png")}
        />
...
Transferring Solutions Next Moment`}</Text>
      ...
      />
      <View style={[styles.services2Child, styles.services2Layout]} />
      <Image
        style={styles.vectorIcon3}
        contentFit="cover"
        source={require("../assets/vector6.png")}
      />
      <View style={[styles.services2Inner, styles.services2Layout]}>
        <View style={[styles.groupParent3, styles.services2Layout]}>
          <View style={[styles.groupParent3, styles.services2Layout]}>
            <View style={[styles.groupChild16, styles.mockups1Position]} />
            <Image
              style={[styles.image1559Icon, styles.iconLayout5]}
              contentFit="cover"
              source={require("../assets/image-1559.png")}
            />
            <Image
              style={styles.image1561Icon}
              contentFit="cover"
              source={require("../assets/image-1561.png")}
            />
            <View style={[styles.groupChild17, styles.groupChild17Position]} />
            <View style={styles.digitalMarketingParent}>
              <Text style={[styles.digitalMarketing, styles.orTypo]}>
                DIGITAL MARKETING
              </Text>
              <Image
            ...
            >{`Lorem Ipsum is simply dummy text of the printing and `}</Text>
            <Image
              style={styles.image1562Icon}
              contentFit="cover"
              source={require("../assets/image-1562.png")}
            />
          </View>
          <Pressable
          ...
          <Image
            style={[styles.image1553Icon, styles.iconLayout5]}
            contentFit="cover"
            source={require("../assets/image-15531.png")}
          />
        </View>
      </View>
    </View>
