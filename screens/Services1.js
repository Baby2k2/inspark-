  ...
  return (
    <View style={styles.services1}>
      ...
      <View style={[styles.services, styles.servicesPosition]}>
        <Image
          style={styles.image1551Icon}
          contentFit="cover"
          source={require("../assets/image-1551.png")}
        />
        ...
        <Pressable
          style={[styles.servicesChild, styles.frameLayout1]}
        ...
        <LinearGradient
          style={[styles.servicesItem, styles.containerPosition]}
          locations={[0, 0.32, 0.71, 1]}
          colors={[
            "rgba(0, 141, 202, 0)",
            "rgba(24, 148, 202, 0)",
        ...
        <View style={[styles.servicesInner, styles.servicesInnerLayout]}>
          <View style={[styles.ellipseParent, styles.servicesInnerLayout]}>
            <Image
              style={[styles.ellipseParent, styles.servicesInnerLayout]}
              contentFit="cover"
        ...
        <View style={styles.uiDesignParent}>
          ...
          <View style={[styles.design, styles.designLayout]}>
            <View style={[styles.rectangleContainer, styles.designLayout]}>
              ...
              <Image
                style={[styles.d2Icon, styles.iconLayout]}
                contentFit="cover"
...
Transferring Solutions Next Moment`}</Text>
      ...
      <View style={[styles.services1Inner, styles.groupParent3Layout]}>
        <View style={[styles.groupParent3, styles.groupParent3Layout]}>
          <View style={[styles.groupParent3, styles.groupParent3Layout]}>
            <View style={[styles.groupChild16, styles.mockups1Position]} />
            <Image
              style={[styles.image1579Icon, styles.iconLayout]}
              contentFit="cover"
              source={require("../assets/image-1579.png")}
            />
            <View style={[styles.groupChild17, styles.groupChild17Position]} />
            <View style={styles.graphicDesigningParent}>
              <Text style={[styles.graphicDesigning, styles.orTypo]}>
                GRAPHIC DESIGNING
              </Text>
              <Image
            ...
            <Image
              style={[styles.image1560Icon, styles.groupInnerLayout]}
              contentFit="cover"
          ...
          <Image
            style={[styles.image1580Icon, styles.groupChild17Position]}
            contentFit="cover"
            source={require("../assets/image-1580.png")}
          />
          <Pressable
          ...
          <Image
            style={[styles.image1553Icon, styles.iconLayout]}
            contentFit="cover"
            source={require("../assets/image-1553.png")}
          />
        </View>
      </View>
      <Image
