  ...
  return (
    <View style={styles.services4}>
      ...
      <View style={[styles.services, styles.servicesPosition]}>
        <Image
          style={[styles.image1564Icon, styles.iconLayout5]}
          contentFit="cover"
          source={require("../assets/image-1564.png")}
        />
        <Image
          style={[styles.image1556Icon, styles.iconLayout3]}
          contentFit="cover"
          source={require("../assets/image-15562.png")}
        />
...
employees`}</Text>
        ...
        <View style={styles.uiDesignParent}>
          <View style={[styles.uiDesign, styles.uiDesignLayout]}>
            ...
            <View style={[styles.uiDesignsWrapper, styles.viewPosition]}>
...
Transferring Solutions Next Moment`}</Text>
      ...
      />
      <View style={[styles.services4Inner, styles.groupParent3Layout]}>
        <View style={[styles.groupParent3, styles.groupParent3Layout]}>
          <View style={[styles.groupParent3, styles.groupParent3Layout]}>
            <View style={styles.groupChild16} />
            <Image
              style={[styles.image1569Icon, styles.iconLayout5]}
              contentFit="cover"
              source={require("../assets/image-1569.png")}
            />
            <Image
              style={[styles.image1570Icon, styles.designLayout]}
              contentFit="cover"
              source={require("../assets/image-1570.png")}
            />
            <View style={[styles.groupChild17, styles.groupChild17Position]} />
            <View style={styles.cloudCommunicationParent}>
              <Text style={[styles.cloudCommunication, styles.orTypo]}>
                CLOUD COMMUNICATION
              </Text>
              <Image
            ...
            >{`Lorem Ipsum is simply dummy text of the printing and `}</Text>
            <Image
              style={styles.image1577Icon}
              contentFit="cover"
              source={require("../assets/image-1577.png")}
            />
          </View>
          <Pressable
